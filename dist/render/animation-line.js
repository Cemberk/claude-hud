import { getFullAnimation, getCompactAnimation } from './animations.js';
 ...
 */
function detectActivityState(ctx) {
 ...
 */
export function renderAnimationFull(ctx) {
 ...
 */
export function renderAnimationCompact(ctx) {
    const { state, detail, startTime } = detectActivityState(ctx);
 ...
 */
export function renderAnimationLine(ctx) {
...
//# sourceMappingURL=animation-line.js.map